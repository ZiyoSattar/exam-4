...
// PAGINATION
let elPagList = document.querySelector(".js-panigation-list");
let elPagItem = document.querySelector(".page-item");
let elPageText = document.querySelector(".page-pagination");
...
// PAGINATION BTNS 
let pageButtons = document.querySelector(".movies__btns-pg");
let pageButtonsRs = document.querySelector(".movies__page-rs");
let page = 1;
...
elSearchForm.addEventListener("submit", function (evt) {
  ...
  page = 1;
  pageButtonsRs.textContent = page;
